...
<div class="col-md-12"> 
        ...
        <div class="col-md-4 inputGroupContainer"><strong>Password</strong>
         ...
         <div class="col-md-4 selectContainer"><strong>Department</strong>
            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-hand-right"></i></span>
          ...
          <div class="col-md-4 selectContainer"><strong>Part/Year</strong>
            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-hand-right"></i></span>
          ...
          <div class="col-md-4 selectContainer"><strong>Semester</strong>
            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-hand-right"></i></span>
 ...
 <?php
        include "../../connection/connection.php";
          if(isset($_POST['btnRegisterStaffUpdate']))
          {
            ...
            $varimplink = mysqli_real_escape_string($objCon,trim($_POST['implinkname']));
            ...
            $varQualification = mysqli_real_escape_string($objCon,strtoupper(trim($_POST['qualification'])));



    
      $varUpdateQ="UPDATE tbl_registration_student SET first_name ='$varFirstName',mid_name ='$varMiddleName',last_name ='$varLastName',email ='$varEmail',contact ='$varMobileNumber',birth_date ='$varBirthDate',photo ='$uploadfileAsP',user_name ='$varUserName',gender ='$varGender', password='$varPasswordF', qualification='$varQualification'  WHERE user_name='$varLoginUserName'";
