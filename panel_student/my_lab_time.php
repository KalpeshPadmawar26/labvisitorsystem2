...
if (isset($_SESSION["varSesUserType"]) AND $_SESSION["varSesUserType"]=="LoginSuccessStudent")
{
     ...
     $sqlRE = "SELECT $varFieldNames FROM $varTableName WHERE student_id='$varLoginID' ORDER BY created DESC";
       ...
       <div class="col-md-12">
        ...
        <?php
         while($rowRE=$rsRE->fetch_assoc())
         {
             ...
             $sqlSD = "SELECT * FROM tbl_registration_student WHERE user_name ='$varLoginID'";
