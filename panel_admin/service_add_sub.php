<?php
$navPage='sub services';
$varFormTitle="Sub Service";
                                    ...
                                    <div class="panel panel-default" style="border:2px solid #430c54; box-shadow: 10px 10px 10px #430c54;">
                                        ...
                                        <div class="panel-body">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" value="SUBSERVICE<?php echo $idcount?>" name="code" class="form-control" readonly> 
                                                </div>
                                            </div><!-- form-group -->
                                        ...
                                        <tbody>
                                         ...
                                         ?>  
                                          <tr>
                                            ...
                                            <td>SUBSERVICE<?php echo $row['evtid']; ?></td>
...
if(isset($_POST["sub"]))
{
    ...
    for($i=0;$i<count($_FILES["fileUpload"]["name"]);$i++)
    {
      ...
      $navigatePage="service_add_sub.php?q=$added_for";

          echo "<script>location='$navigatePage'</script>";      
