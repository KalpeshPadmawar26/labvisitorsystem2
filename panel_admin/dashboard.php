...
<div class="row">
             ...
             <div class="row">
             	<div class="col-md-6 col-sm-6 col-lg-6 col-xs-6">
             		<div class="icon-featured">
                		<center><img src="../images/education/png/student.png" alt="HTML examples" class="img img-responsive" width="70%"></center>
              		</div>	
             	</div>
             	...
             	<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
             		<h4 class="text-uppercase"><strong>All Entries</strong></h4>
             	</div>
             </div>
   ...
   <div class="col-md-3 col-sm-3 col-lg-3">
        	<a href="my_lab_time_today.php">
          <div class="featured-box">
            <div class="box-content">
             <div class="row">
             	<div class="col-md-6 col-sm-6 col-lg-6 col-xs-6">
             		<div class="icon-featured">
                		<center><img src="../images/education/png/chat.png" alt="HTML examples" class="img img-responsive" width="70%"></center>
              		</div>	
             	</div>
             	...
             	<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
             		<h4 class="text-uppercase"><strong>Todays Entries</strong></h4>
             	</div>
             </div>
          ...
          <div class="featured-box">
            <div class="box-content">
             <div class="row">
             	...
             	<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
             		<h4 class="text-uppercase"><strong>Add Notes</strong></h4>
             	</div>
            ...
            <div class="box-content">
             <div class="row">
             	...
             	<div class="col-md-6 col-sm-6 col-lg-6 col-xs-6">
              	...
              	<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
             		<h4 class="text-uppercase"><strong> Manage Students </strong></h4>
             	</div>
             </div>
