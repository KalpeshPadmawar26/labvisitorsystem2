...
$result = $con->selectsort('tbl_events',"evtid='{$id}'",'sequence');
$resultdialogs = $con->select('tbl_events',"evtid='{$id}' limit 0,1");
							   ...
							   <div class="col-md-6">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            ...
                                            <h4 class="panel-title">Edit <strong><?php echo $rowdialogs['event_name']." (SUBSERVICE".$rowdialogs['evtid'].")"; ?></strong></h4>
                                           
                                        </div>
                                        <div class="panel-body">
                                         
                                        <div class="panel-footer">
                                            <button class="btn btn-primary mr5" data-toggle="modal" data-target="#editevent" name="update">Edit</button>
                                            <button  class="btn btn-primary mr5" data-toggle="modal" data-target="#editimage">Upload Another Pic</button>
                                        </div><!-- panel-footer -->
                                    </div><!-- panel-default -->
                                    </div>
                                    ...
                                    <table class="table table-primary mb30">
										...
										while($row=mysqli_fetch_array($result))
                                        {
                                          ...
                                          <tr id="recordsArray_<?php echo $row['id']; ?>">
                                            ...
                                            <td><a href="service_delete.php?id=<?php echo $row['id'];?>&evtid=<?php echo $row['evtid'];?>" onclick="return confirm('Are you sure you want to Delete?');"><span class="fa fa-trash-o"></span></a></td>
